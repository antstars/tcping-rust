...
Go to the [Releases](https://github.com/antstars/tcping-rust/releases) page and download the executable file that matches your operating system and architecture.
...
前往 [Releases](https://github.com/antstars/tcping-rust/releases) 页面，下载与你的操作系统和架构相匹配的可执行文件即可开箱即用。
